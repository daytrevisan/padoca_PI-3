...
<html lang="pt-br">
    ...
    <P>
        <div class="container">
          ...
          <hr> <hr> <hr> <hr> <hr> <hr> <h4 class="page-header">PROCESSOS DE FABRICAÇÃO CADASTRADOS</h4>
               ...
               <div class="table-responsive">
                    <table class="table table-hover">
                          ...
                          <?php
                            ...
                            $resultado = mysqli_query($conexao, "SELECT g4_cont, g4_prod, g4_descr_prod, g4_roteiro, g4_operacao, g4_tempo_med, g4_valor, g4_custo FROM sg4 WHERE g4_prod like '%".$search."%' ORDER BY g4_prod, g4_roteiro, g4_operacao");
