               ...
               <div class="table-responsive">
                    <table class="table table-hover">
                          ...
                          <tbody>                      
                            ...
                            $sql = "SELECT p1_cont, p1_ficha, p1_descr_ficha, p1_tipo, p1_situacao, p1_vl_total, p1_vl_acumulado FROM pv1 where p1_situacao='3-Fechada' ORDER BY p1_ficha DESC";
