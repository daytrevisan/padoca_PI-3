...
<html lang="pt-br">
    ...
    <P>
        <div class="container">
          ...
          <h4 class="page-header">Ordens de Produção</h4>
               ...
               <div class="table-responsive">
                    <table class="table table-hover">
                          ...
                          <?php
                            ...
                            $resultado = mysqli_query($conexao, "SELECT g5_cont, g5_ordem, g5_situacao, g5_prod, g5_descr_prod, g5_entrega, g5_qtd_planej, g5_qtd_boas, g5_qtd_refugo, g5_qtd_sucata, g5_qtd_saldo, g5_roteiro, g5_bx_comp, g5_apon_oper FROM sg5 WHERE g5_prod like '%".$search."%' ORDER BY g5_ordem, g5_prod, g5_entrega");
                            while($linha = mysqli_fetch_array($resultado))
                            {
                               echo '<tr>';                  
                                   ...
                                   echo  '<td>'.$linha['g5_qtd_refugo'].'</td>';  
