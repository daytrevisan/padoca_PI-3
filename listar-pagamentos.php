               ...
               <div class="table-responsive">
                    <table class="table table-hover">
                          ...
                          <tbody>                      
                            ...
                            //fazendo a seleção da tabela PV4
                            $sql = "SELECT p4_cont, p4_ficha, p4_tipo, p4_situacao, p4_forma_pagto, p4_vl_total, p4_vl_pago, p4_vl_troco, p4_data, p4_hora FROM pv4 where p4_situacao='4-Pagamento' ORDER BY p4_cont DESC";
