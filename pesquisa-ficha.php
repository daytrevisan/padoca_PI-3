                    ...
                    <table class="table table-hover">
                          ...
                          <tbody>                      
                            <?php
                             ...
                             $resultado = mysqli_query($conexao, "SELECT p1_cont, p1_ficha, p1_descr_ficha, p1_tipo, p1_situacao, p1_vl_total, p1_vl_acumulado FROM pv1 WHERE p1_ficha like '%".$search."%' ");
