...
<html lang="pt-br">
    ...
    <P>
        <div class="container">
          ...
          <hr> <hr> <hr> <hr> <hr> <hr> <h4 class="page-header">APONTAMENTOS DE PRODUÇÃO</h4>
               ...
               <div class="table-responsive">
                    <table class="table table-hover">
                          ...
                          <?php
                           ...
                           $resultado = mysqli_query($conexao, "SELECT g6_cont, g6_ordem, g6_operacao, g6_descr_oper, g6_prod, g6_descr_prod, g6_data_ini, g6_hora_ini, g6_data_fim, g6_hora_fim, g6_qtd_boas, g6_qtd_refugo, g6_qtd_sucata FROM sg6 WHERE g6_ordem like '%".$search."%' ORDER BY g6_ordem, g6_operacao, g6_data_ini");
