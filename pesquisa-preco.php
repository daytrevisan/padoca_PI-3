               ...
               <div class="table-responsive">
                    <table class="table table-hover">
                          ...
                          <tbody>                      
                            ...
                            $resultado = mysqli_query($conexao, "SELECT p2_cont, p2_prod, p2_descr_prod, p2_um, p2_preco, p2_familia, p2_data_val, p2_data_atu FROM pv2 WHERE p2_prod like '%".$search."%' ORDER BY p2_prod");
