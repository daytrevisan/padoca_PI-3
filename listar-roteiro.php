...
<html lang="pt-br">
    ...
    <P>
        <div class="container">
          ...
          <h4 class="page-header">Roteiros de Fabricação Cadastrados</h4>
               ...
               <div class="table-responsive">
                    <table class="table table-hover">
                          ...
                          <tbody>                      
                            ...
                            $sql = "SELECT g3_cont, g3_roteiro, g3_operacao, g3_descr_oper, g3_ctrab, g3_arranjo, g3_ccusto FROM sg3 ORDER BY g3_roteiro, g3_operacao";
