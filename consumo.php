...
<html lang="pt-br">
    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-body-tertiary shadow-lg p-3 mb-5 bg-white rounded"> <!--Barra Superior-->
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="listar-consumo.php">Listar Consumo</a>
        </li> 
        <li class="nav-item">
    ...
    <P>
        ...
        <h4 class="page-header">Consumo de Padaria</h4>
         <hr>
            <form action="cadastro-consumo.php" method="POST" enctype="multipart/form-data" name="upload">
              <div class="row">
                ...
                <div class="form-group col-md-3">
                  ...
                  <input class="form-control form-control-sm col-md-10 col-sm-10" type="text" name="c_qtde" placeholder="Informe a quantidade" required/>
                </div>
                  <hr>
                  <div class="row">
                  <div class="form-group col-md-8">
                <input type="submit" class="btn btn-primary" id="btn-apontar" name="btn_enviar" value="Apontar Consumo">
            </form>
